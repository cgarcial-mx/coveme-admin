...
return (
  <Card className="w-full max-w-md">
    ...
    <CardContent className="grid gap-4">
      ...
      >
        <div className="grid gap-2">
          ...
          <Input id="email" name="email" type="email" placeholder="you@company.com" required defaultValue="admin@example.com" />
        </div>
        <div className="grid gap-2">
    ...
    <CardFooter className="flex w-full items-center justify-between text-sm text-muted-foreground">
      <Link href="#" className="underline hover:text-foreground">Forgot password?</Link>
      <span>© {new Date().getFullYear()} OmniMarket</span>
    </CardFooter>
  </Card>
)
}
